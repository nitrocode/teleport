...
- Define the connector [resource](../setup/reference/resources.mdx) and save it into
  a YAML file (like `connector.yaml`). We recommend the usage of helper commands to achieve this for [SAML](../setup/reference/cli.mdx#tctl-sso-configure-saml), [OIDC](../setup/reference/cli.mdx#tctl-sso-configure-oidc) and [GitHub](../setup/reference/cli.mdx#tctl-sso-configure-github) connectors.
- Test the connector for validity using [`tctl sso test`](../setup/reference/cli.mdx#tctl-sso-test) command.
