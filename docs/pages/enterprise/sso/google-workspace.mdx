---
title: SSO with Google Workspace (G Suite)
description: How to configure Teleport Single Sign-On with Google Workspace (G Suite)
h1: Single Sign-On with Google Workspace (G Suite)
...
When used in combination with role based access control (RBAC) it allows administrators
...
## Test your Google Workspace OIDC connector
