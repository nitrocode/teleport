---
title: SSO with OAuth2 and OIDC
description: How to configure Teleport Single Sign-On with OAuth2 and OIDC
h1: Single Sign-On with OAuth2 and OIDC
---
...
When used in combination with role based access control (RBAC) it allows 
